...
class MSO70KCCommandConstants:
    """The MSO70KC command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO70KC
    commands.
    """
...
class MSO70KCCommands:
    """The MSO70KC commands.

    This provides access to all the commands for the MSO70KC device. See the documentation of each
...
class MSO70KCMixin:
    """A mixin that provides access to the MSO70KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO70KC command argument constants.
        - ``.commands``: The MSO70KC commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = MSO70KCCommandConstants()
        self._commands = MSO70KCCommands(device)

    @property
    def command_argument_constants(self) -> MSO70KCCommandConstants:
        """Return the MSO70KC command argument constants.
    ...
    @property
    def commands(self) -> MSO70KCCommands:
        """Return the MSO70KC commands.

        This provides access to all the commands for the MSO70KC device. See the documentation of
