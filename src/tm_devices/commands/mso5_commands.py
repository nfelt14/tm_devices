...
class MSO5CommandConstants:
    """The MSO5 command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO5
    commands.
    """
...
class MSO5Commands:
    ...
    This provides access to all the commands for the MSO5 device. See the documentation of each
...
class MSO5Mixin:
    """A mixin that provides access to the MSO5 commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO5 command argument constants.
        - ``.commands``: The MSO5 commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = MSO5CommandConstants()
        self._commands = MSO5Commands(device)

    @property
    def command_argument_constants(self) -> MSO5CommandConstants:
        """Return the MSO5 command argument constants.
    ...
    @property
    def commands(self) -> MSO5Commands:
        """Return the MSO5 commands.
