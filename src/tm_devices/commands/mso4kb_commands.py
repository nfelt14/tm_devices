...
class MSO4KBCommandConstants:
    """The MSO4KB command argument constants.
...
class MSO4KBCommands:
    """The MSO4KB commands.

    This provides access to all the commands for the MSO4KB device. See the documentation of each
...
class MSO4KBMixin:
    """A mixin that provides access to the MSO4KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO4KB command argument constants.
    ...
    def commands(self) -> MSO4KBCommands:
        ...
        This provides access to all the commands for the MSO4KB device. See the documentation of
