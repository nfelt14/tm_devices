...
from .gen_3skc3w_dpo.trigger import Trigger
...
class DPO7KCCommandConstants:
    """The DPO7KC command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO7KC
    commands.
    """
...
class DPO7KCCommands:
    """The DPO7KC commands.

    This provides access to all the commands for the DPO7KC device. See the documentation of each
...
class DPO7KCMixin:
    """A mixin that provides access to the DPO7KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO7KC command argument constants.
        - ``.commands``: The DPO7KC commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DPO7KCCommandConstants()
        self._commands = DPO7KCCommands(device)

    @property
    def command_argument_constants(self) -> DPO7KCCommandConstants:
        """Return the DPO7KC command argument constants.
    ...
    @property
    def commands(self) -> DPO7KCCommands:
        """Return the DPO7KC commands.

        This provides access to all the commands for the DPO7KC device. See the documentation of
