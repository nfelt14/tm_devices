...
class MSO6CommandConstants:
    """The MSO6 command argument constants.
...
class MSO6Commands:
    ...
    This provides access to all the commands for the MSO6 device. See the documentation of each
...
class MSO6Mixin:
    """A mixin that provides access to the MSO6 commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO6 command argument constants.
