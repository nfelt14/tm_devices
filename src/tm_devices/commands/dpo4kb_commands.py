...
class DPO4KBCommandConstants:
    """The DPO4KB command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO4KB
    commands.
    """
...
class DPO4KBCommands:
    """The DPO4KB commands.

    This provides access to all the commands for the DPO4KB device. See the documentation of each
...
class DPO4KBMixin:
    """A mixin that provides access to the DPO4KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO4KB command argument constants.
        - ``.commands``: The DPO4KB commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DPO4KBCommandConstants()
        self._commands = DPO4KBCommands(device)

    @property
    def command_argument_constants(self) -> DPO4KBCommandConstants:
        """Return the DPO4KB command argument constants.
    ...
    @property
    def commands(self) -> DPO4KBCommands:
        """Return the DPO4KB commands.

        This provides access to all the commands for the DPO4KB device. See the documentation of
