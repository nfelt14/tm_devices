...
class MDO4KCCommandConstants:
    """The MDO4KC command argument constants.
...
class MDO4KCCommands:
    """The MDO4KC commands.

    This provides access to all the commands for the MDO4KC device. See the documentation of each
...
class MDO4KCMixin:
    """A mixin that provides access to the MDO4KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The MDO4KC command argument constants.
    ...
    def commands(self) -> MDO4KCCommands:
        ...
        This provides access to all the commands for the MDO4KC device. See the documentation of
