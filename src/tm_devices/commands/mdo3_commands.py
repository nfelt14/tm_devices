...
from .gen_ujuvb_mdo.trigger import Trigger
from .helpers import DefaultDictPassKeyToFactory


# pylint: disable=too-few-public-methods
class MDO3CommandConstants:
...
class MDO3Commands:
    ...
    This provides access to all the commands for the MDO3 device. See the documentation of each
    ...
    Properties:
        ...
        - ``.set``: The ``SET`` command.
        - ``.setup1``: The ``SETUP1<x>`` command tree.
...
class MDO3Mixin:
    ...
    Properties:
        - ``.command_argument_constants``: The MDO3 command argument constants.
