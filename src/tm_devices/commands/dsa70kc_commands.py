...
class DSA70KCCommandConstants:
    """The DSA70KC command argument constants.

    This provides access to all the string constants which can be used as arguments for DSA70KC
    commands.
    """
...
class DSA70KCCommands:
    """The DSA70KC commands.

    This provides access to all the commands for the DSA70KC device. See the documentation of each
...
class DSA70KCMixin:
    """A mixin that provides access to the DSA70KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The DSA70KC command argument constants.
        - ``.commands``: The DSA70KC commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DSA70KCCommandConstants()
        self._commands = DSA70KCCommands(device)

    @property
    def command_argument_constants(self) -> DSA70KCCommandConstants:
        """Return the DSA70KC command argument constants.
    ...
    @property
    def commands(self) -> DSA70KCCommands:
        """Return the DSA70KC commands.

        This provides access to all the commands for the DSA70KC device. See the documentation of
