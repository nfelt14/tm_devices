...
class DPO5KCommandConstants:
    """The DPO5K command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO5K
    commands.
    """
...
class DPO5KCommands:
    ...
    This provides access to all the commands for the DPO5K device. See the documentation of each
...
class DPO5KMixin:
    """A mixin that provides access to the DPO5K commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO5K command argument constants.
        - ``.commands``: The DPO5K commands.
    """
    ...
    @property
    def command_argument_constants(self) -> DPO5KCommandConstants:
        """Return the DPO5K command argument constants.
    ...
    @property
    def commands(self) -> DPO5KCommands:
        """Return the DPO5K commands.
