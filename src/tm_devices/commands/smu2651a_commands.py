...
from .gen_am6pcr_smu.status import Status
...
class SMU2651ACommandConstants:
    """The SMU2651A command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2651A
    commands.
    """
...
class SMU2651ACommands:
    """The SMU2651A commands.

    This provides access to all the commands for the SMU2651A device. See the documentation of each
    ...
    def config_pulse_i_measure_v(
        ...
        **TSP Syntax:**
        ...
        Args:
            smu: Instrument channel (set to smua).
    ...
    def config_pulse_i_measure_v_sweep_log(
        ...
        **TSP Syntax:**
        ...
        Args:
            ...
            toff: Pulse off time in seconds.
            points: Number of pulse-measure cycles.
            buffer: Reading buffer where pulsed measurements will be stored; if this is nil when the
...
class SMU2651AMixin:
    """A mixin that provides access to the SMU2651A commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2651A command argument constants.
        - ``.commands``: The SMU2651A commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, TSPDevice) else None
        self._command_argument_constants = SMU2651ACommandConstants()
        self._commands = SMU2651ACommands(device)

    @property
    def command_argument_constants(self) -> SMU2651ACommandConstants:
        """Return the SMU2651A command argument constants.
    ...
    @property
    def commands(self) -> SMU2651ACommands:
        """Return the SMU2651A commands.

        This provides access to all the commands for the SMU2651A device. See the documentation of
