...
class DPO70KDCommandConstants:
    """The DPO70KD command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO70KD
    commands.
    """
...
class DPO70KDCommands:
    """The DPO70KD commands.

    This provides access to all the commands for the DPO70KD device. See the documentation of each
...
class DPO70KDMixin:
    """A mixin that provides access to the DPO70KD commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO70KD command argument constants.
        - ``.commands``: The DPO70KD commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DPO70KDCommandConstants()
        self._commands = DPO70KDCommands(device)

    @property
    def command_argument_constants(self) -> DPO70KDCommandConstants:
        """Return the DPO70KD command argument constants.
    ...
    @property
    def commands(self) -> DPO70KDCommands:
        """Return the DPO70KD commands.

        This provides access to all the commands for the DPO70KD device. See the documentation of
