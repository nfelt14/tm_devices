...
class DSA70KDCommandConstants:
    """The DSA70KD command argument constants.

    This provides access to all the string constants which can be used as arguments for DSA70KD
    commands.
    """
...
class DSA70KDCommands:
    """The DSA70KD commands.

    This provides access to all the commands for the DSA70KD device. See the documentation of each
...
class DSA70KDMixin:
    """A mixin that provides access to the DSA70KD commands and constants.

    Properties:
        - ``.command_argument_constants``: The DSA70KD command argument constants.
        - ``.commands``: The DSA70KD commands.
    """
    ...
    @property
    def command_argument_constants(self) -> DSA70KDCommandConstants:
        """Return the DSA70KD command argument constants.
    ...
    @property
    def commands(self) -> DSA70KDCommands:
        """Return the DSA70KD commands.

        This provides access to all the commands for the DSA70KD device. See the documentation of
