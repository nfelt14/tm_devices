...
from .gen_53md2e_dpomso.fpanel import Fpanel
from .gen_561g9r_mso.trigger import Trigger
...
class MSO5KBCommandConstants:
    """The MSO5KB command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO5KB
    commands.
    """
...
class MSO5KBCommands:
    """The MSO5KB commands.

    This provides access to all the commands for the MSO5KB device. See the documentation of each
...
class MSO5KBMixin:
    """A mixin that provides access to the MSO5KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO5KB command argument constants.
        - ``.commands``: The MSO5KB commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = MSO5KBCommandConstants()
        self._commands = MSO5KBCommands(device)

    @property
    def command_argument_constants(self) -> MSO5KBCommandConstants:
        """Return the MSO5KB command argument constants.
    ...
    @property
    def commands(self) -> MSO5KBCommands:
        """Return the MSO5KB commands.

        This provides access to all the commands for the MSO5KB device. See the documentation of
