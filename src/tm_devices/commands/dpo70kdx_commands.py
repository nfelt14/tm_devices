...
class DPO70KDXCommandConstants:
    """The DPO70KDX command argument constants.
...
class DPO70KDXCommands:
    """The DPO70KDX commands.

    This provides access to all the commands for the DPO70KDX device. See the documentation of each
...
class DPO70KDXMixin:
    """A mixin that provides access to the DPO70KDX commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO70KDX command argument constants.
    ...
    def commands(self) -> DPO70KDXCommands:
        ...
        This provides access to all the commands for the DPO70KDX device. See the documentation of
