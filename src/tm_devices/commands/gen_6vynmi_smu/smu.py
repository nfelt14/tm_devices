...
class SmuSourceVlimit(BaseTSPCmd):
    ...
    def tripped(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.tripped`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
...
class SmuSource(BaseTSPCmd):
    ...
    def readback(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.readback`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def pulsesweeplinear(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.pulsesweeplinear()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def pulsesweeplinearstep(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.pulsesweeplinearstep()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def pulsesweeplist(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.pulsesweeplist()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def pulsesweeplog(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.pulsesweeplog()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def pulsetrain(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.pulsetrain()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sweeplinear(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.sweeplinear()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sweeplinearstep(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.sweeplinearstep()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sweeplist(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.sweeplist()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sweeplog(
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.sweeplog()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
...
class SmuMeasure(BaseTSPCmd):
    ...
    def autorangehigh(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.autorangehigh`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def autorangelow(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.autorangelow`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def autorangerebound(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.autorangerebound`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def offsetcompensation(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.offsetcompensation`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
...
class SmuContact(BaseTSPCmd):
    ...
    def checkall(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.checkall()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
...
class Smu(BaseTSPCmd):
    ...
    def fastrangechange(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.fastrangechange`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def priorityvoltage(self) -> str:
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.priorityvoltage`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
