...
class CursorSource(SCPICmdWrite, SCPICmdRead):
    ...
    **Description:**
        - This command specifies the cursor source waveform, which can be one of channels, reference
          waveforms, math waveform, bus, digital channels with option 3-MSO), or AUTO. When the
          cursor source is set to AUTO, cursor readouts apply to the currently selected waveform.
    ...
    def source(self) -> CursorSource:
        ...
        **Description:**
            - This command specifies the cursor source waveform, which can be one of channels,
              reference waveforms, math waveform, bus, digital channels with option 3-MSO), or AUTO.
              When the cursor source is set to AUTO, cursor readouts apply to the currently selected
              waveform.
