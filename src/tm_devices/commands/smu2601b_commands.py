...
class SMU2601BCommandConstants:
    """The SMU2601B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2601B
    commands.
    """
...
class SMU2601BCommands:
    """The SMU2601B commands.

    This provides access to all the commands for the SMU2601B device. See the documentation of each
...
class SMU2601BMixin:
    """A mixin that provides access to the SMU2601B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2601B command argument constants.
        - ``.commands``: The SMU2601B commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, TSPDevice) else None
        self._command_argument_constants = SMU2601BCommandConstants()
        self._commands = SMU2601BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2601BCommandConstants:
        """Return the SMU2601B command argument constants.
    ...
    @property
    def commands(self) -> SMU2601BCommands:
        """Return the SMU2601B commands.

        This provides access to all the commands for the SMU2601B device. See the documentation of
