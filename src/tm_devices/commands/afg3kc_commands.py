...
class AFG3KCCommandConstants:
    """The AFG3KC command argument constants.

    This provides access to all the string constants which can be used as arguments for AFG3KC
    commands.
    """
...
class AFG3KCCommands:
    """The AFG3KC commands.

    This provides access to all the commands for the AFG3KC device. See the documentation of each
...
class AFG3KCMixin:
    """A mixin that provides access to the AFG3KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The AFG3KC command argument constants.
        - ``.commands``: The AFG3KC commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = AFG3KCCommandConstants()
        self._commands = AFG3KCCommands(device)

    @property
    def command_argument_constants(self) -> AFG3KCCommandConstants:
        """Return the AFG3KC command argument constants.
    ...
    @property
    def commands(self) -> AFG3KCCommands:
        """Return the AFG3KC commands.

        This provides access to all the commands for the AFG3KC device. See the documentation of
