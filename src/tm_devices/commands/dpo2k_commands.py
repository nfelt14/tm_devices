...
class DPO2KCommandConstants:
    """The DPO2K command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO2K
    commands.
    """
...
class DPO2KCommands:
    ...
    This provides access to all the commands for the DPO2K device. See the documentation of each
...
class DPO2KMixin:
    """A mixin that provides access to the DPO2K commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO2K command argument constants.
        - ``.commands``: The DPO2K commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DPO2KCommandConstants()
        self._commands = DPO2KCommands(device)

    @property
    def command_argument_constants(self) -> DPO2KCommandConstants:
        """Return the DPO2K command argument constants.
    ...
    @property
    def commands(self) -> DPO2KCommands:
        """Return the DPO2K commands.
