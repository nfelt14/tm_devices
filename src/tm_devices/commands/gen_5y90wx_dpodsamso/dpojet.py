...
Commands and Queries:
    ...
    - DPOJET:ACTIVATE
    - DPOJET:ADDMeas {PERIod | CCPeriod | FREQuency | NPERiod | PWIdth | NWIdth | PDUTy | NDUTy |
      PCCDuty | NCCDuty | DATARATE | TIE | RJ | RJDirac | TJber | DJ | DJDirac | PHASENoise | DCD |
      DDJ | PJ | J2 | J9 | SRJ | PJrms | SJFREQ | PKPKCLKTJ | PKPKCLKRJ | PKPKCLKDJ | PJRMS | FN |
      RJH | RJV | PJH | PJV | RN | RNV| RNH | DN | DDN | DDN_1 | DDN_0 | PN | PNV | PNH | NPN |
      TNBER | NOISESUMMARY | UNITAMPLITUDE | RISEtime | SETup | HIGHTime | FALLtime | HOLD | LOWTime
      | SKEW | GATEDSKEW | HEIght | WIDth | MASKHits | WIDTHBer | HEIGHTBer |CYCLEMIN | CYCLEMAX |
      ACRMS | ACCOMmonmode | COMmonmode | HIGH | TNTratio | HIGHLOW | LOW | VDIFFxovr | RISESLEWrate
      | FALLSLEWrate | OVERShoot | UNDERShoot | CYCLEPktopk | JITTERSummary | PCIETTXDiffpp |
      PCIEDEemph | PCIETTx | PCIETTXRise | PCIETTXFall | PCIEUI | PCIETMinpulse | PCIEMEdmxjitter |
      PCIETRfmismch | PCIESSCFReqdev | PCIEMAXMINratio | PCIESSCPROFile | PCIEVEye | PCIETTXUTJ |
      PCIETTXUDJDD | PCIETTXUPWTJ | PCIETTXUPWDJDD | PCIETTXDDJ | PCIEVTXBOOST | PCIEVTXNOEQ |
      PCIEVTXEIEOS | PCIEPS21TX | PCIEACCommonmode | VTXDiffpp | TMINPULSETJ | TCDRslewmax | USBUI |
      USBACCommonmode | TMINPULSEDJ | QFACTOR | EYELOW | EYEHIGH | TCMDTOCMD | TIMEOUTSIDELEVEL |
      SSCFREQDEVMAX | SSCFREQDEVMIN | SSCFREQDEV |SSCMODrate | SSCPROfile | USBSSCFREQDEVMAX |
      USBSSCFREQDEVMIN | USBSSCMODrate | USBSSCPROFile | AUTOFITMaskhits | AOP | EXRATIO | OMA |
      OPTHIGH | OPTLOW| EYECROSSLEVEL | EYECROSSTIME | EYECROSSPERCENT | DFEEW | DFEEH |
      DFEEYEDIAGRAM | VWOE | MASKMARGIN | MASKHITRATIO | RIN | RINXOMA | TDEC }
    - DPOJET:ADDPlot {TIMEtrend | DATAarray | HISTOgram | SPECtrum | TRANSfer | PHASEnoise | EYE |
      WAVEform | BATHtub | QBathtub | QPulsewidth | COMPOSITEJitterhist | NOISEBAthtub | BERContour
    ...
    - DPOJET:MEAS<x>:CLOCKRecovery:METHod {STANDARD | CUSTOM | CONSTMEAN | CONSTFIXED | EXPEDGE |
      EXPPLL | CONSTMEDIAN | BEHAVIORAL}
    ...
    - DPOJET:MEAS<x>:CUSTOMGATING:SOURCE1GATE {GATE1 | GATE2 | GATE3 GATE4 | GATE5 | GATE6 | GATE7 |
      GATE8 | GATE9 | GATE10 | GATE11 | GATE12 | GATE13 | GATE14 | GATE15 | GATE16 | NONE}
    - DPOJET:MEAS<x>:CUSTOMGATING:SOURCE1GATE?
    - DPOJET:MEAS<x>:CUSTOMGATING:SOURCE2GATE {GATE1 | GATE2 | GATE3 GATE4 | GATE5 | GATE6 | GATE7 |
      GATE8 | GATE9 | GATE10 | GATE11 | GATE12 | GATE13 | GATE14 | GATE15 | GATE16 | NONE }
    ...
    - DPOJET:PLOT<x>:COMPOSITEJitterhist:NUMBins {TWENtyfive | FIFTY | HUNdred | TWOFifty |
    ...
    - DPOJET:PLOT<x>:COMPOSITENoisehist:NUMBins { TWENtyfive | FIFTY | HUNdred | TWOFifty |
      FIVEHundred | TWOThousand | MAXimum}
    ...
    - DPOJET:PLOT<x>:HISTOgram:NUMBins {TWENtyfive | FIFTY | HUNdred | TWOFifty | FIVEHundred |
      TWOThousand | MAXimum}
    ...
    - DPOJET:PLOT<x>:PHASEnoise:SMOOTHENINGFilter {ONEBYHUNDREDTHdecade | ONEBYTENTHDECADE |
      ONEDECADE}
