...
from .gen_16x4xq_mdo.search import Search
...
class MDO4KBCommandConstants:
    """The MDO4KB command argument constants.

    This provides access to all the string constants which can be used as arguments for MDO4KB
    commands.
    """
...
class MDO4KBCommands:
    """The MDO4KB commands.

    This provides access to all the commands for the MDO4KB device. See the documentation of each
...
class MDO4KBMixin:
    """A mixin that provides access to the MDO4KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The MDO4KB command argument constants.
        - ``.commands``: The MDO4KB commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = MDO4KBCommandConstants()
        self._commands = MDO4KBCommands(device)

    @property
    def command_argument_constants(self) -> MDO4KBCommandConstants:
        """Return the MDO4KB command argument constants.
    ...
    @property
    def commands(self) -> MDO4KBCommands:
        """Return the MDO4KB commands.

        This provides access to all the commands for the MDO4KB device. See the documentation of
