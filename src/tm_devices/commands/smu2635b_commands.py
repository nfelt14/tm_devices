...
class SMU2635BMixin:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._command_argument_constants = SMU2635BCommandConstants()
        self._commands = SMU2635BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2635BCommandConstants:
