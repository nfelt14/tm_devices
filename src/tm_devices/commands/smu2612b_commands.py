...
class SMU2612BMixin:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._command_argument_constants = SMU2612BCommandConstants()
        self._commands = SMU2612BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2612BCommandConstants:
