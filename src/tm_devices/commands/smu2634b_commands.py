...
class SMU2634BCommandConstants:
    """The SMU2634B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2634B
    commands.
    """
...
class SMU2634BCommands:
    """The SMU2634B commands.

    This provides access to all the commands for the SMU2634B device. See the documentation of each
...
class SMU2634BMixin:
    """A mixin that provides access to the SMU2634B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2634B command argument constants.
        - ``.commands``: The SMU2634B commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, TSPDevice) else None
        self._command_argument_constants = SMU2634BCommandConstants()
        self._commands = SMU2634BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2634BCommandConstants:
        """Return the SMU2634B command argument constants.
    ...
    @property
    def commands(self) -> SMU2634BCommands:
        """Return the SMU2634B commands.

        This provides access to all the commands for the SMU2634B device. See the documentation of
