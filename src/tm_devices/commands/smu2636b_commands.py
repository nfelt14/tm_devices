...
class SMU2636BCommandConstants:
    """The SMU2636B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2636B
    commands.
    """
...
class SMU2636BCommands:
    """The SMU2636B commands.

    This provides access to all the commands for the SMU2636B device. See the documentation of each
...
class SMU2636BMixin:
    """A mixin that provides access to the SMU2636B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2636B command argument constants.
        - ``.commands``: The SMU2636B commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, TSPDevice) else None
        self._command_argument_constants = SMU2636BCommandConstants()
        self._commands = SMU2636BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2636BCommandConstants:
        """Return the SMU2636B command argument constants.
    ...
    @property
    def commands(self) -> SMU2636BCommands:
        """Return the SMU2636B commands.

        This provides access to all the commands for the SMU2636B device. See the documentation of
