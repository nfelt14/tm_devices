    ...
    def calibratebiasi(
        ...
        **TSP Syntax:**
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to run the ``{self._cmd_syntax}.calibratebiasi()`` function."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sensev(self) -> str:
        ...
        **TSP Syntax:**
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.sensev`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
    ...
    def sourcev(self) -> str:
        ...
        **TSP Syntax:**
        ...
        try:
            ...
            msg = f"No TSPDevice object was provided, unable to access the ``{self._cmd_syntax}.sourcev`` attribute."  # noqa: E501
            raise NoDeviceProvidedError(msg) from error
