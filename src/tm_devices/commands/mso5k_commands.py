...
class MSO5KCommandConstants:
    """The MSO5K command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO5K
    commands.
    """
...
class MSO5KCommands:
    ...
    This provides access to all the commands for the MSO5K device. See the documentation of each
...
class MSO5KMixin:
    ...
    Properties:
        - ``.command_argument_constants``: The MSO5K command argument constants.
        - ``.commands``: The MSO5K commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = MSO5KCommandConstants()
        self._commands = MSO5KCommands(device)
    ...
    @property
    def commands(self) -> MSO5KCommands:
