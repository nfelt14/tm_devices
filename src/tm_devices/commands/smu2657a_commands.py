...
class SMU2657ACommandConstants:
    """The SMU2657A command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2657A
    commands.
    """
...
class SMU2657ACommands:
    """The SMU2657A commands.

    This provides access to all the commands for the SMU2657A device. See the documentation of each
...
class SMU2657AMixin:
    ...
    Properties:
        - ``.command_argument_constants``: The SMU2657A command argument constants.
        - ``.commands``: The SMU2657A commands.
    """
    ...
    @property
    def commands(self) -> SMU2657ACommands:
        """Return the SMU2657A commands.

        This provides access to all the commands for the SMU2657A device. See the documentation of
