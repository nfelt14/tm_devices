...
class DPO2KBCommandConstants:
    """The DPO2KB command argument constants.
...
class DPO2KBCommands:
    """The DPO2KB commands.

    This provides access to all the commands for the DPO2KB device. See the documentation of each
...
class DPO2KBMixin:
    """A mixin that provides access to the DPO2KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO2KB command argument constants.
    ...
    def commands(self) -> DPO2KBCommands:
        ...
        This provides access to all the commands for the DPO2KB device. See the documentation of
