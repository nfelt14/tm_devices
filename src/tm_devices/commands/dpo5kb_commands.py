...
from .gen_3tjgb2_dpo.trigger import Trigger
...
class DPO5KBCommandConstants:
    """The DPO5KB command argument constants.

    This provides access to all the string constants which can be used as arguments for DPO5KB
    commands.
    """
...
class DPO5KBCommands:
    """The DPO5KB commands.

    This provides access to all the commands for the DPO5KB device. See the documentation of each
...
class DPO5KBMixin:
    """A mixin that provides access to the DPO5KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO5KB command argument constants.
        - ``.commands``: The DPO5KB commands.
    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        device = self if isinstance(self, PIDevice) else None
        self._command_argument_constants = DPO5KBCommandConstants()
        self._commands = DPO5KBCommands(device)

    @property
    def command_argument_constants(self) -> DPO5KBCommandConstants:
        """Return the DPO5KB command argument constants.
    ...
    @property
    def commands(self) -> DPO5KBCommands:
        """Return the DPO5KB commands.

        This provides access to all the commands for the DPO5KB device. See the documentation of
