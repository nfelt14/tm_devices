...
class SMU2614BMixin:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._command_argument_constants = SMU2614BCommandConstants()
        self._commands = SMU2614BCommands(device)

    @property
    def command_argument_constants(self) -> SMU2614BCommandConstants:
